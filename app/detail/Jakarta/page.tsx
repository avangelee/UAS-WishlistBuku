...
export default function JakartaDetail() {
  ...
  async function addToWishlist() {
    ...
    const { error } = await supabase.from('wishlist').insert([
      {
        user_id: user.id,
        book_title: 'Jakarta Sebelum Pagi',
        author: 'Ziggy Zezsyazeoviennazabrizkie',
        image_url: '/Jakarta.webp',
      },
    ]);
  ...
  return (
    <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row gap-10">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <h1 className="text-3xl font-bold text-pink-800">Jakarta Sebelum Pagi</h1>
