...
export default function IkanDilangitDetail() {
  ...
  async function addToWishlist() {
    ...
    const { error } = await supabase.from('wishlist').insert([
      {
        user_id: user.id,
        book_title: 'Semua Ikan Dilangit',
        author: 'Ziggy Zezsyazeoviennazabrizkie',
        image_url: '/IkanDilangit.jpg',
      },
    ]);
  ...
  return (
    <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row gap-10">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <h1 className="text-3xl font-bold text-pink-800">Semua Ikan Dilangit</h1>
